...
embed_df = pd.read_csv(
    "C:/Users/Alex/Desktop/python/DASH/Web_Trader/apps/dash-nlp/data/tsne_bigram_data.csv", index_col=0
)  # Bigram embedding dataframe, with placeholder tsne values (at perplexity=3)
vects_df = pd.read_csv(
    "C:/Users/Alex/Desktop/python/DASH/Web_Trader/apps/dash-nlp/data/bigram_vectors.csv", index_col=0
)  # Simple averages of GLoVe 50d vectors
bigram_df = pd.read_csv("C:/Users/Alex/Desktop/python/DASH/Web_Trader/apps/dash-nlp/data/bigram_counts_data.csv", index_col=0)

DATA_PATH = pathlib.Path(__file__).parent.resolve()
EXTERNAL_STYLESHEETS = ["https://codepen.io/chriddyp/pen/bWLwgP.css"]
FILENAME = "data/customer_complaints_narrative_sample.csv"
FILENAME_PRECOMPUTED = "C:/Users/Alex/Desktop/python/DASH/Web_Trader/apps/dash-nlp/data/precomputed.json"
PLOTLY_LOGO = "https://sdweg.files.wordpress.com/2016/09/l62697-new-twitter-logo-49466.png"
        ...
        html.A(
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.NavbarBrand("Twitter Sentiment Analysis", className="m9-10")
                    ),
                ],
                align="center",
                no_gutters=True,
